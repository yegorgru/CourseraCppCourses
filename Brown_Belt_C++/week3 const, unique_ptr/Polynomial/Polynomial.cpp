...
public:
    ...
    public:
        ...
        bool operator== (const T& value) const {
            return degree_ < poly_.coeffs_.size() ? poly_.coeffs_[degree_] == value : value == 0;
        }

        ostream& operator<< (ostream& os) {
            return os << degree_ < poly_.coeffs_.size() ? poly_.coeffs_[degree_] : 0;
        }
